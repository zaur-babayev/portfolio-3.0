...
if (breakButton) {
  breakButton.addEventListener("click", initSimulation);

  const img = breakButton.querySelector("img");
    if (img) {
      img.src = "https://uploads-ssl.webflow.com/6364d0ad4443c4f2436e099a/6662cd6654137412436c713a_oh_you_pressed_illustration.svg";  // Set the new image URL here
    }
}
