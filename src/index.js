...
document.addEventListener('DOMContentLoaded', (event) => {
  ...
  function initSimulation() {
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
      // Initialize the simulation when the DOM is fully loaded
      var containerElement = document.querySelector(".balls-area");
      var buttonElement = document.querySelector(".break-button");
      ...
      if (!buttonElement) {
        console.error('break-button element not found');
        return;
      }
      ...
      buttonElement.addEventListener("click", () => {
        console.log('Break button clicked, initializing simulation...');
        initSimulation();
      });
    });
